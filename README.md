...
- **Ticker-box restyle (all tables).** Every data-table header that used the dark-tan fill is now black with white text and a red top accent, matching the masthead — applied uniformly across all 13 tables in the four briefs (snapshot, movers, appendix, recap, premarket). The `#ebe7e1` header fill is retired.
